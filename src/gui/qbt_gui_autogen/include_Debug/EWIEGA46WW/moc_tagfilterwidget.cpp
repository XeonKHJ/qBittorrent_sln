...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/tagfilterwidget.h"
...
void TagFilterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TagFilterWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TagFilterWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_TagFilterWidget.data,
    qt_meta_data_TagFilterWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
