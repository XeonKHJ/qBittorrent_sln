...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/torrentcontentmodel.h"
...
void TorrentContentModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TorrentContentModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TorrentContentModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_TorrentContentModel.data,
    qt_meta_data_TorrentContentModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
