...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/fspathedit.h"
...
void FileSystemPathEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FileSystemPathEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject FileSystemPathEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_FileSystemPathEdit.data,
    qt_meta_data_FileSystemPathEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
