...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/categoryfiltermodel.h"
...
QT_MOC_LITERAL(6, 77, 25), // "BitTorrent::Torrent*const"
QT_MOC_LITERAL(7, 103, 7), // "torrent"
QT_MOC_LITERAL(8, 111, 23), // "torrentAboutToBeRemoved"
QT_MOC_LITERAL(9, 135, 22), // "torrentCategoryChanged"
QT_MOC_LITERAL(10, 158, 11), // "oldCategory"
QT_MOC_LITERAL(11, 170, 27) // "subcategoriesSupportChanged"
...
void CategoryFilterModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CategoryFilterModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 2: _t->torrentAdded((*reinterpret_cast< BitTorrent::Torrent*const(*)>(_a[1]))); break;
        case 3: _t->torrentAboutToBeRemoved((*reinterpret_cast< BitTorrent::Torrent*const(*)>(_a[1]))); break;
        case 4: _t->torrentCategoryChanged((*reinterpret_cast< BitTorrent::Torrent*const(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
...
QT_INIT_METAOBJECT const QMetaObject CategoryFilterModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CategoryFilterModel.data,
    qt_meta_data_CategoryFilterModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
