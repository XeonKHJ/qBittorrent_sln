...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/downloadfromurldialog.h"
...
void DownloadFromURLDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DownloadFromURLDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DownloadFromURLDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_DownloadFromURLDialog.data,
    qt_meta_data_DownloadFromURLDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
