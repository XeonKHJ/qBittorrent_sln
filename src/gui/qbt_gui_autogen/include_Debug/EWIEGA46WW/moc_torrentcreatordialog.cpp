...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/torrentcreatordialog.h"
...
void TorrentCreatorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TorrentCreatorDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TorrentCreatorDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_TorrentCreatorDialog.data,
    qt_meta_data_TorrentCreatorDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
