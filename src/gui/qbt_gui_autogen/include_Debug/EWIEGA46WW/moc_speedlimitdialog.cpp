...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/speedlimitdialog.h"
...
void SpeedLimitDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SpeedLimitDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SpeedLimitDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_SpeedLimitDialog.data,
    qt_meta_data_SpeedLimitDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
