...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/programupdater.h"
...
QT_MOC_LITERAL(3, 36, 19), // "rssDownloadFinished"
QT_MOC_LITERAL(4, 56, 19), // "Net::DownloadResult"
QT_MOC_LITERAL(5, 76, 6) // "result"

    },
    "ProgramUpdater\0updateCheckFinished\0\0"
    "rssDownloadFinished\0Net::DownloadResult\0"
    "result"
};
...
void ProgramUpdater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ProgramUpdater *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateCheckFinished(); break;
        case 1: _t->rssDownloadFinished((*reinterpret_cast< const Net::DownloadResult(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProgramUpdater::*)();
...
QT_INIT_METAOBJECT const QMetaObject ProgramUpdater::staticMetaObject = { {
    ...
    qt_meta_stringdata_ProgramUpdater.data,
    qt_meta_data_ProgramUpdater,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ProgramUpdater::updateCheckFinished()
{
