...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/properties/proplistdelegate.h"
...
static const uint qt_meta_data_PropListDelegate[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, 0x80000000 | 4, 0x80000000 | 11, 0x80000000 | 8,    5,   12,    9,
...
void PropListDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PropListDelegate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PropListDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_PropListDelegate.data,
    qt_meta_data_PropListDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
