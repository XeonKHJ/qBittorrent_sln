...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/properties/pieceavailabilitybar.h"
...
QT_INIT_METAOBJECT const QMetaObject PieceAvailabilityBar::staticMetaObject = { {
    QMetaObject::SuperData::link<PiecesBar::staticMetaObject>(),
    qt_meta_stringdata_PieceAvailabilityBar.data,
    qt_meta_data_PieceAvailabilityBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
