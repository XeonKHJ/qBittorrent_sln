...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/properties/trackersadditiondialog.h"
...
QT_MOC_LITERAL(3, 54, 27), // "torrentListDownloadFinished"
QT_MOC_LITERAL(4, 82, 19), // "Net::DownloadResult"
QT_MOC_LITERAL(5, 102, 6) // "result"

    },
    "TrackersAdditionDialog\0"
    "on_uTorrentListButton_clicked\0\0"
    "torrentListDownloadFinished\0"
...
void TrackersAdditionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TrackersAdditionDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_uTorrentListButton_clicked(); break;
        case 1: _t->torrentListDownloadFinished((*reinterpret_cast< const Net::DownloadResult(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject TrackersAdditionDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_TrackersAdditionDialog.data,
    qt_meta_data_TrackersAdditionDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
