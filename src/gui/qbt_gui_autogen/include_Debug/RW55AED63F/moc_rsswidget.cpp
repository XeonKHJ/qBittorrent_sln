...
#include <memory>
#include "../../../../../../qBittorrent/src/gui/rss/rsswidget.h"
...
void RSSWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RSSWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->unreadCountUpdated((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->deleteSelectedItems(); break;
        case 2: _t->updateRefreshInterval((*reinterpret_cast< int(*)>(_a[1]))); break;
...
QT_INIT_METAOBJECT const QMetaObject RSSWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_RSSWidget.data,
    qt_meta_data_RSSWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
