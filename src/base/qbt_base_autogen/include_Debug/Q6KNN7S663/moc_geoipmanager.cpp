...
#include <memory>
#include "../../../../../../qBittorrent/src/base/net/geoipmanager.h"
...
QT_MOC_LITERAL(4, 46, 14), // "DownloadResult"
QT_MOC_LITERAL(5, 61, 6) // "result"

    },
    "Net::GeoIPManager\0configure\0\0"
    "downloadFinished\0DownloadResult\0result"
};
...
void Net::GeoIPManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GeoIPManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->configure(); break;
        case 1: _t->downloadFinished((*reinterpret_cast< const DownloadResult(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject Net::GeoIPManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_Net__GeoIPManager.data,
    qt_meta_data_Net__GeoIPManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
