...
#include <memory>
#include "../../../../../../qBittorrent/src/base/bittorrent/torrentcreatorthread.h"
...
void BitTorrent::TorrentCreatorThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TorrentCreatorThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject BitTorrent::TorrentCreatorThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_BitTorrent__TorrentCreatorThread.data,
    qt_meta_data_BitTorrent__TorrentCreatorThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
