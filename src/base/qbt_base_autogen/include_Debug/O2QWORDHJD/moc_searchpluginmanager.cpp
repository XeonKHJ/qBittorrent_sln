...
#include <memory>
#include "../../../../../../qBittorrent/src/base/search/searchpluginmanager.h"
...
void SearchPluginManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SearchPluginManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SearchPluginManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_SearchPluginManager.data,
    qt_meta_data_SearchPluginManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
