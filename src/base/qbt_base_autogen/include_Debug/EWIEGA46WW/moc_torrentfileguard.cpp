...
#include <memory>
#include "../../../../../../qBittorrent/src/base/torrentfileguard.h"
...
QT_INIT_METAOBJECT const QMetaObject TorrentFileGuard::staticMetaObject = { {
    QtPrivate::MetaObjectForType<FileGuard>::value(),
    qt_meta_stringdata_TorrentFileGuard.data,
    qt_meta_data_TorrentFileGuard,
    nullptr,
    nullptr,
    nullptr
} };
