...
#include <memory>
#include "../../../../../../qBittorrent/src/base/asyncfilestorage.h"
...
void AsyncFileStorage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AsyncFileStorage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AsyncFileStorage::staticMetaObject = { {
    ...
    qt_meta_stringdata_AsyncFileStorage.data,
    qt_meta_data_AsyncFileStorage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
