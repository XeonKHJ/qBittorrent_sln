...
#include <memory>
#include "../../../../../../qBittorrent/src/webui/api/transfercontroller.h"
...
QT_MOC_LITERAL(9, 163, 14) // "banPeersAction"
    ...
    "setUploadLimitAction\0setDownloadLimitAction\0"
    "banPeersAction"
};
...
void TransferController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->banPeersAction(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
